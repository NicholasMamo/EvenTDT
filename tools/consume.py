...
def create_consumer(consumer, queue, filters=None, splits=None, threshold_type=None, with_default_split=False, *args, **kwargs):
    ...
    kwargs['threshold'] = threshold_type if consumer.__name__ in { 'FUEGOConsumer', 'SEERConsumer' } else kwargs.get('threshold')
...
def consumer(consumer):
    ...
    The accepted consumers are:
        ...
        #. :class:`~queues.consumers.algorithms.fuego_consumer.SEERConsumer`,
