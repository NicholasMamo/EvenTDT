...
The full list of accepted arguments:
    ...
    - ``-f --file``                          *<Required>* The file to use to construct the tokenized corpus, which can be an original corpus collected by the :mod:`~tools.collect` tool or a timeline generated by the :mod`~tools.consume` tool.
...
def setup_args():
    ...
    parser.add_argument('-f', '--file', type=str, required=True,
                        help='<Required> The file to use to construct the tokenized corpus, which can be an original corpus collected by the `collect` tool or a timeline generated by the `consume` tool.')
...
def tokenize_corpus(file, output, tokenizer, keep=None, remove_retweets=False):
    ...
    :param file: The path to the corpus or timeline file.
    :type file: str
    :param output: The output path.
