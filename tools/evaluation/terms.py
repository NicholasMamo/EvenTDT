...
.. code-block:: json
    ...
    {
        "cmd": {
            "_cmd": "EvenTDT/tools/evaluation/terms.py  --file evaluation/ate/results/terms.json  --gold evaluation/ate/results/gold.txt  --output evaluation/ate/results/results.json --stem --unigrams --verbose",
