...
class TestEvent(unittest.TestCase):
    ...
    def test_eficf_same_as_efidf(self):
        """
        Test that the EF-ICF scores are the same as EF-IDF's.
        """
        ...
        extractor = event.EFICF(idf, base=2)
    ...
    def test_ef_icf_entropy_same_as_ef_idf_entropy(self):
        """
        Test that EF-ICF-Entropy's scores are the same as EF-IDF-Entropy's.
        """
        ...
        extractor = event.EFICFEntropy(idf, base=2)
        self.assertEqual(terms, extractor.extract(timelines, idfs))
