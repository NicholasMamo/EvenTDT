...
class TestPackage(unittest.TestCase):
    ...
    def test_user_statuses_retweet_with_id(self):
        """
        Test that getting the number of user statuses from a retweet with the original author's ID returns the original author's favourites.
        """
    ...
    def test_user_statuses_quoted_with_id(self):
        """
        Test that getting the number of user statuses from a quoted tweet with the original author's ID returns the original author's favourites.
        """
    ...
    def test_user_followers_retweet_with_id(self):
        """
        Test that getting the number of user followers from a retweet with the original author's ID returns the original author's favourites.
        """
    ...
    def test_user_followers_quoted_with_id(self):
        """
        Test that getting the number of user followers from a quoted tweet with the original author's ID returns the original author's favourites.
        """
    ...
    def test_user_description_retweet(self):
        """
        Test that getting the description from a retweet returns the retweeting author's followers.
        """
    ...
    def test_user_description_quoted(self):
        """
        Test that getting the description from a quoted tweet returns the quoting author's followers.
        """
