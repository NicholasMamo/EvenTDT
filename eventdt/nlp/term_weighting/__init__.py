...
class TermWeightingScheme(object):
	...
	The scheme then multiplies the scores of each to :func:`~nlp.term_weighting.scheme.TermWeightingScheme.create` a :class:`~nlp.document.Document`.

	:ivar local_scheme: The local term-weighting scheme.
	:vartype local_scheme: :class:`~nlp.term_weighting.scheme.Scheme`
	:ivar global_scheme: The global term-weighting scheme.
	:vartype global_scheme: :class:`~nlp.term_weighting.scheme.Scheme`
	"""
	...
	def __init__(self, local_scheme, global_scheme):
		...
		:type local_scheme: :class:`~nlp.term_weighting.scheme.Scheme`
		:param global_scheme: The global term-weighting scheme.
		:type global_scheme: :class:`~nlp.term_weighting.scheme.Scheme`
		"""
...
class SchemeScorer(ABC):
	...
	It is important to distinguish between :class:`~nlp.term_weighting.scheme.TermWeightingScheme` and :class:`~nlp.term_weighting.scheme.SchemeScorer`.
	The former is a complete term-weighting scheme that takes local and global scheme scorers.
	The latter is the actual scorer.
	A :class:`~nlp.term_weighting.scheme.SchemeScorer` is a component of a term-weighting scheme.
	A :class:`~nlp.term_weighting.scheme.TermWeightingScheme` combines local and global scorers to create documents.
	"""
