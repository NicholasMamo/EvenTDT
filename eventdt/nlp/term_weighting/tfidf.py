...
The TFIDF is simply the multiplication of the :class:`eventdt.nlp.term_weighting.local_schemes.tf.TF` and :class:`eventdt.nlp.term_weighting.global_schemes.idf.IDF` term-weighting schemes:
