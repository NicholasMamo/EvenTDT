"""
Run unit tests on the :class:`eventdt.nlp.term_weighting.global_schemes.filler.Filler` class.
"""
...
class TestFiller(unittest.TestCase):
	"""
	Test the :class:`eventdt.nlp.term_weighting.global_schemes.filler.Filler` class.
	"""
