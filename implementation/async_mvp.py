"""
This implementation is similar to mvp.py
The difference is that it is not split over different processes
Thus, it can only run on one CPU core
"""
...
KEYWORDS = ["#SWESUI", "#SUISWE", "#SWE", "#SUI"]
