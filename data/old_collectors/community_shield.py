...
FILENAME = "/home/memonick/data/twitter/CommunityShield.json"
EVENT_DURATION = 60*60*4.5
KEYWORDS = ["#CommunityShield", "#CFC", "#MCFC", "#CHEMCI", "#MCICHE", "community", "shield", "manchester", "city", "chelsea"]
