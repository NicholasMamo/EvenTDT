...
BASE_NAME = "MUNARS_FUL.json"
SEED_SET = ["#MUNARS", "Manchester United", "Arsenal"]

PARTICIPANTS = ["Old Trafford", "José Mourinho", "Unai Emery",
	'David de Gea', 'Eric Bailly', 'Chris Smalling', 'Marcos Rojo',
	'Diogo Dalot', 'Nemanja Matic', 'Ander Herrera', 'Matteo Darmian',
	'Jesse Lingard', 'Marcus Rashford', 'Anthony Martial',
	'Paul Pogba', 'Juan Mata', 'Romelu Lukaku', 'Sergio Romero', 'Antonio Valencia', 'Marouane Fellaini', 'Scott McTominay',

	'Bernd Leno', 'Sokratis Papastathopoulos', 'Shkodran Mustafi', 'Rob Holding',
	'Hector Bellerin', 'Lucas Torreira', 'Matteo Guendouzi', 'Sead Kolašinac',
	'Aaron Ramsey', 'Pierre-Emerick Aubameyang', 'Alex Iwobi',
	'Petr Čech', 'Mohamed Elneny', 'Henrikh Mkhitaryan', 'Alexandre Lacazette', 'Stephan Lichtsteiner', 'Ainsley Maitland-Niles', 'Eddie Nketiah'
	]
