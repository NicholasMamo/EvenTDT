...
BASE_NAME = "UFC231_FUL.json"
SEED_SET = ["#UFC231"]

PARTICIPANTS = [
	'Max Holloway', 'Brian Ortega',
	'Valentina Shevchenko (fighter)', 'Joanna Jędrzejczyk',
	'Alex Oliveira (fighter)', 'Gunnar Nelson (fighter)',
	'Hakeem Dawodu', 'Kyle Bochniak',
	'Jimi Manuwa', 'Thiago Santos (fighter)',
]

FILENAME = "/mnt/data/twitter/%s" % (BASE_NAME)
EVENT_DURATION = 3600 * 4.5
IDF = "idf.json"
